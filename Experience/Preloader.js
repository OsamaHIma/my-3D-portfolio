...
export default class Preloader extends EventEmitter {
  ...
  setAssets() {
    ...
    convert(document.querySelector(".hero-second-title"));
  ...
  firstIntro() {
    return new Promise((resolve) => {
      ...
      if (this.device === "desktop") {
        this.timeline
          .to(this.roomChildren.small_cube.scale, {
            x: 1.4,
            y: 1.4,
            z: 1.4,
            ease: "back.out(2.5)",
  ...
  secondIntro() {
    return new Promise((resolve) => {
      ...
      this.secondTimeline
        ...
        .to(
          this.roomChildren.small_cube.rotation,
          {
        ...
        .to(
          this.roomChildren.small_cube.scale,
          {
            x: 10,
            y: 10,
            z: 10,
        ...
        .set(this.roomChildren.bg.scale, {
          x: 1,
          y: 1,
          z: 1,
        })
        ...
        .to(
          this.roomChildren.sketchfab_model002.scale,
          {
            x: 1,
            y: 1,
            z: 1,
        ...
        .set(this.roomChildren.gym_floor.scale, {
          x: 1,
          y: 1,
          z: 1,
        })
        .to(
          this.roomChildren.cahir.scale,
          {
            x: 1,
            y: 1,
            z: 1,
        ...
        .to(
          this.roomChildren.cahir.rotation,
          {
